...
@section('container')
        ...
        <div class="col-md-6 mb-3">
            <form action="/posts">
                ...
                <div class="input-group mb-3">
                    ...
                    <button class="btn btn btn-dark" type="submit" id="button-addon2">Search</button>
                </div>
            </form>
        </div>
    </div>
    ...
    @if ($posts->count())
        <div class="card mb-3">
          <img src="//source.unsplash.com/1200x400?{{$posts[0]->category->name}}" class="card-img-top" alt="{{$posts[0]->category->name}}">
        ...
        <div class="row">
            @foreach ($posts->skip(1) as $post)
                ...
                <div class="card">
                  ...
                  <img src="//source.unsplash.com/500x400?{{$post->category->name}}" class="card-img-top" class="card-img-top" alt="{{$post->category->name}}">
                  <div class="card-body">
